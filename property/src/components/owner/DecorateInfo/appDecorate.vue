<template>
	...
	<div>
		<el-form :model="House" label-width="100px" class="demo-ruleForm">
			...
			<el-form-item style="position: absolute;top:580px;left: 570px;">
				<el-button type="primary" style="width: 100px;" @click="processDecorate()">验收</el-button>
				<el-button type="danger" style="width: 100px;" @click="inidedDecorate()">作废</el-button>
			</el-form-item>
		</el-form>
	</div>
</template>
